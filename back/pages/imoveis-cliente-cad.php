...
if (isset($_SESSION['id']) and (isset($_SESSION['nome'])) and ($_SESSION['nivel'] == 1)) {
    ...
    $query = "SELECT imo.id, cli.nome, imo.fk_nome_cli, imo.cod_imovel, imo.area, ende.valor_imovel, img.images, ende.endereco, ende.num_casa, ende.estado, ende.bairro, imo.dormitorio, imo.banheiro, imo.suite, imo.vagas, imo.piscina, imo.churrasqueira, imo.descricao, sit.situacao, sit.tipo_imovel 
    FROM  imoveis As imo
    ...
    INNER JOIN cad_cliente As cli
    ON imo.fk_nome_cli = cli.id
    WHERE imo.fk_nome_cli LIKE :tt
