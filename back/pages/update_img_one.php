...
//  var_dump($rest);
 ...
 if($result_db_id->rowCount()){
    ...
    $_SESSION['banner'] = "<div style='margin-bottom:1rem; width: 100%; background-color:#D1E7DD; color: #0a3622; padding: 1rem; border: 1px solid #a3cfbb; border-radius:8px;'>Selecionado com Sucesso!</div>";
